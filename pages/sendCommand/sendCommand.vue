	...
	export default {
		...
		methods:{
			...
			labelTest(){
				...
				command.setGap(0)
				command.setCls()
				command.setQR(180, 10, "L", 5, "A", "gxpg202203170002")
				command.setText(1, 10, "TSS24.BF2", 1, 1, "大机切料")
				command.setText(1, 60, "TSS24.BF2", 1, 1, "张三")
				command.setText(1, 120, "TSS24.BF2", 1, 1, "2022-03-12 08:00:00")
				command.setText(1, 150, "TSS24.BF2", 1, 1, "38x19x1.5加筋(901)维克方转角沙发右底座侧")
				command.setText(1, 180, "TSS24.BF2", 1, 1, "边管用料,分切两根,钻孔")
